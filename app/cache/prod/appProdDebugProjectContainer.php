...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDebug_Templating_Engine_PhpService()
    {
        ...
        $instance->setHelpers(array('slots' => 'templating.helper.slots', 'assets' => 'templating.helper.assets', 'request' => 'templating.helper.request', 'session' => 'templating.helper.session', 'router' => 'templating.helper.router', 'actions' => 'templating.helper.actions', 'code' => 'templating.helper.code', 'translator' => 'templating.helper.translator', 'form' => 'templating.helper.form', 'stopwatch' => 'templating.helper.stopwatch', 'logout_url' => 'templating.helper.logout_url', 'security' => 'templating.helper.security', 'assetic' => 'assetic.helper.static', 'facebook' => 'fos_facebook.helper', 'imagine' => 'liip_imagine.templating.helper'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'seekerplusJokte', 'user' => 'root', 'password' => 'undertaker', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b96ba88fd5c78c4f6230037fc7ba52273075062197cc69ed780e2dd461528289');
    ...
    {
        return $this->services['fos_facebook.api'] = new \FOS\FacebookBundle\Facebook\FacebookSessionPersistence(array('appId' => '1624937491053026', 'secret' => 'e652d53551951d62227cf94c52e90e07', 'cookie' => true, 'domain' => NULL), $this->get('session'));
    }
    ...
    {
        return $this->services['fos_facebook.helper'] = new \FOS\FacebookBundle\Templating\Helper\FacebookHelper($this->get('templating'), $this->get('fos_facebook.api'), $this->get('router'), true, 'en_US', array(0 => 'email', 1 => 'user_birthday', 2 => 'user_location', 3 => 'user_hometown'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('SeekerPlus\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('SeekerPlus\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'SeekerPlus\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('4311c47452e370f6b8f9dad13222508544c6ff2a');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \SeekerPlus\UserBundle\Security\User\Provider\FacebookProvider A SeekerPlus\UserBundle\Security\User\Provider\FacebookProvider instance.
     */
    protected function getMy_Facebook_UserService()
    {
        return $this->services['my.facebook.user'] = new \SeekerPlus\UserBundle\Security\User\Provider\FacebookProvider($this->get('fos_facebook.api'), $this->get('fos_user.user_manager'), $this->get('validator'), $this);
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.public' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/.*'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_PublicService()
    {
        ...
        return $this->services['security.firewall.map.context.public'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($d, array(0 => new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $b, 1 => $c)), 1 => $b, 2 => $c), 'public', $a, $e), 2 => $q, 3 => new \FOS\FacebookBundle\Security\Firewall\FacebookListener($d, $h, $i, $p, 'public', $r, $s, array('app_url' => 'https://apps.facebook.com/seekerplus', 'server_url' => 'http://localhost/SeekerPlusWeb/web/app_dev.php/', 'check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'display' => 'page', 'create_user_if_not_exists' => false, 'redirect_to_facebook_login' => true), $a, $e), 4 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $h, $i, $p, 'public', $t, $u, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $e, NULL), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '557c460ce1161', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($d, $this->get('security.access.decision_manager'), $o, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $p, 'public', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $p, 'fos_user_security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('locationTwig', 'Fusagasuga, Cundinamarca');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SeekerPlus/PagesBundle/Resources/views'), 'Pages');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/SeekerPlus/UserBundle/Resources/views'), 'User');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SeekerPlus/AdsmanagerBundle/Resources/views'), 'Adsmanager');
        $instance->addPath(($this->targetDirs[3].'/vendor/liip/imagine-bundle/Liip/ImagineBundle/Resources/views'), 'LiipImagine');
        $instance->addPath(($this->targetDirs[3].'/src/SeekerPlus/BannerBundle/Resources/views'), 'Banner');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4311c47452e370f6b8f9dad13222508544c6ff2a');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/SeekerPlus/AdsmanagerBundle/Resources/config/validation.yml')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PagesBundle' => 'SeekerPlus\\PagesBundle\\PagesBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'UserBundle' => 'SeekerPlus\\UserBundle\\UserBundle',
                'FOSFacebookBundle' => 'FOS\\FacebookBundle\\FOSFacebookBundle',
                'AdsmanagerBundle' => 'SeekerPlus\\AdsmanagerBundle\\AdsmanagerBundle',
                'LiipImagineBundle' => 'Liip\\ImagineBundle\\LiipImagineBundle',
                'BannerBundle' => 'SeekerPlus\\BannerBundle\\BannerBundle',
                'SwisDatabaseExtraBundle' => 'Swis\\Bundle\\DatabaseExtraBundle\\SwisDatabaseExtraBundle',
            ),
            ...
            'latitude' => 4.3436000000000003,
            'longitude' => -74.361900000000006,
            'alias' => 'Fusagasuga',
            'locationid' => 3,
            ...
            'kernel.secret' => '4311c47452e370f6b8f9dad13222508544c6ff2a',
            ...
            'fos_user.model.user.class' => 'SeekerPlus\\UserBundle\\Entity\\User',
            ...
            'fos_facebook.app_id' => '1624937491053026',
            'fos_facebook.secret' => 'e652d53551951d62227cf94c52e90e07',
